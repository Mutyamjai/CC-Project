  ...
  return (
    <div className='absolute inset-0 z-60 bg-black bg-opacity-50 flex items-center justify-center'>
        <div className='bg-spotify-dark-gray border-2 border-blue-700 rounded-lg shadow-xl w-11/12 max-w-lg p-8 relative mt-8'>
                <h1 className='text-2xl font-bold text-center text-blue-500 mb-4'>WASHING ORDER DETAILS</h1>

                <div className='absolute top-2 right-4 text-gray-500'>
                    <button 
                        onClick={() => set_x(false)}
                        className='text-2xl font-bold text-gray-500 hover:text-red-500 focus:outline-none'
                    >
                        X
                    </button>
                </div>
